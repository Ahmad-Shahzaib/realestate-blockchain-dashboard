...
const ProjectDetailsPage = ({ projectId }: ProjectDetailsPageProps) => {
    ...
    return (
        <>
            <div className="w-full custom-border rounded-lg p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="text-xl font-medium ">Urban Dwellings</span>
                        </div>

                        {/* Area I Own */}
                        <div className="flex items-center space-x-2">
                            <span className=" text-sm font-medium">AREA I OWN</span>
                    ...
                    <div className="flex items-center space-x-8">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex flex-col items-center">
                                ...
                                <span className=" font-medium mt-2">Select Area</span>
                            </div>
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex flex-col items-center">
                                ...
                                <span className=" font-medium mt-2">Summary</span>
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <span className=" font-medium mt-2">Confirmation</span>
                        </div>
                    </div>
                </div>
            </div>
