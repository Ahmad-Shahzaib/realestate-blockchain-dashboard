...
export default function Rentals() {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-4 lg:p-6">
            <h3 className="text-lg lg:text-xl font-bold text-[#003049] mb-6">Rentals</h3>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-[#F5F7FA] rounded-xl">
                        ...
                        <div className="text-xl font-bold text-[#003049]">120 PKR / sq.ft. / mo</div>
                    </div>
                    <div className="p-4 bg-[#F5F7FA] rounded-xl">
                        <div className="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2">
                            Next Increase Date
                        </div>
                        <div className="text-xl font-bold text-[#003049]">19 Apr, 2026</div>
                    </div>
                </div>

                {/* Expand/Collapse Button */}
                <button
                    className="flex items-center gap-2 text-[#0277BD] text-sm font-medium hover:text-[#00B894] transition-colors"
                    ...
                    <div className="space-y-6 border-t border-gray-200 pt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 bg-[#F5F7FA] rounded-xl">
                                ...
                                <div className="text-lg font-bold text-[#003049]">1st of each Month</div>
                            </div>
                            <div className="p-4 bg-[#F5F7FA] rounded-xl">
                                <div className="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2">
                                    Locking Date
                                </div>
                                <div className="text-lg font-bold text-[#003049]">Mon</div>
                            </div>
                        </div>

                        {/* Info Note */}
                        <div className="bg-gradient-to-r from-[#00B894]/10 to-[#00D2B6]/10 border border-[#00B894]/30 rounded-xl p-4">
                        ...
                        {/* Rental Growth */}
                        <div className="text-center p-4 bg-[#F5F7FA] rounded-xl">
                                ...
                                <svg width="100%" height="100%" viewBox="0 0 300 120" className="absolute inset-0">
                                    <defs>
                                        <linearGradient id="chartGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                                            <stop offset="0%" style={{ stopColor: '#00B894', stopOpacity: 0.3 }} />
                                            <stop offset="100%" style={{ stopColor: '#00D2B6', stopOpacity: 0.1 }} />
                                        </linearGradient>
                                    </defs>
                                    <polyline
