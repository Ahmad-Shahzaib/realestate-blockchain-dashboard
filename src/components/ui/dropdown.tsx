...
export function DropdownContent({
  ...
  return (
    <div
      ...
      className={cn(
        "inline-flex h-[53px] rounded-[8px] border border-[#E7E7E7] px-[24px] py-[15px] pr-[174px] pb-[14px] items-center flex-shrink-0 min-w-[8rem] absolute z-99 mt-2 origin-top-right bg-white",
        {
